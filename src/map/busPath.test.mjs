...
// 정류장이 리드 구간 안(150m 지점)에 있으면 거기서 DWELL(3.5s) 만큼 시간 소진 →
// speed 10, lead 10s: 5s 만에 150 도달, 3.5s 정차, 남은 1.5s 주행 → 165m
const near = leadAlong(100, 10, 10, [150]);
assert.ok(near >= 150 && near <= 170, `dwell caps at stop: ${near}`);
